  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "exceptionproduction": parse_exceptionproduction,
        "sequenceproduction": parse_sequenceproduction,
        "choiceproduction": parse_choiceproduction,
      ...
      function parse_exceptionproduction() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result3 = parse_whitespace();
              if (result3 !== null) {
                result4 = parse_simpleproduction();
                if (result4 !== null) {
                  result0 = [result0, result1, result2, result3, result4];
                } else {
                  result0 = null;
      ...
      function parse_sequenceproduction() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
        
        pos0 = clone(pos);
        pos1 = clone(pos);
        result0 = parse_exceptionproduction();
        if (result0 !== null) {
          result1 = parse_whitespace();
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result3 = parse_whitespace();
              if (result3 !== null) {
                result4 = parse_sequenceproduction();
                if (result4 !== null) {
                  result0 = [result0, result1, result2, result3, result4];
                } else {
                  result0 = null;
      ...
      function parse_choiceproduction() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
        
        pos0 = clone(pos);
        pos1 = clone(pos);
        result0 = parse_sequenceproduction();
        if (result0 !== null) {
          result1 = parse_whitespace();
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result3 = parse_whitespace();
              if (result3 !== null) {
                result4 = parse_choiceproduction();
                if (result4 !== null) {
                  result0 = [result0, result1, result2, result3, result4];
                } else {
                  result0 = null;
      ...
      function parse_production() {
        ...
        pos0 = clone(pos);
        result0 = parse_choiceproduction();
        if (result0 !== null) {
          result0 = (function(offset, line, column, p) { return p; })(pos0.offset, pos0.line, pos0.column, result0);
        }
        if (result0 === null) {
